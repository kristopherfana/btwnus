...
<Modal visible={modalOpen} animationType={'slide'} style={styles.modal}>
    ...
    <View style={styles.modalCloseButton}>
        <FontAwesome name='close' style={styles.closeButton}  onPress={()=>setModalopen(false)}/>
    </View>
    </View>

    <View style={styles.comments}>
        <View style={styles.commentsCard}>
            <Image style={styles.commentsImg} source={require('../assets/image/profile.jpg')} />
    ...
    <View style={styles.modalFooter}>
        <View style={styles.footer}>
         ...
         <TextInput placeholder='Comment' style={styles.textInput}></TextInput>
        <TouchableOpacity style={{backgroundColor:'black', flex:0.3, justifyContent:'center',alignItems:'center',marginLeft:4, borderRadius:2}}>
